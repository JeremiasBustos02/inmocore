...
import { publicOperationLabels } from "../public-property-options";
import {
  getPublicCities,
...
export async function generateMetadata({
  ...
  const canonical = getOrganizationPublicUrl(organization, "/propiedades");
  const hasFilters = hasQueryParameters(rawSearchParams);
  const suggestions = await getPublicHeroSuggestions(organization.id);
  const operations = suggestions.operations
